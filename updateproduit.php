...
$anciennom = $_POST['nomproduit'];
$ancienprixv = $_POST['prixvente'];
$ancienprixa = $_POST['prixachat'];
$anciennequantite = $_POST['quantite'];

$nouveaunom = $_POST['nomproduit'];
$nouveauprixv= $_POST['prixvente'];
$nouveauprixa = $_POST['prixachat'];
$nouvellequantite= $_POST['quantite'];


if(!empty($_POST['nomproduit'])AND !empty($_POST['prixvente']) AND !empty($_POST['prixvente'])) {
    $insert = $connexion->prepare('UPDATE fournisseur SET nomproduit=$nomproduit, prixvente= $prixvente ,prixachat=$prixachat, quantitestock= $quantite where quantitestock='.$quantite);
