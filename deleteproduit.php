...
<?php
$deleteclient = $connexion->query("DELETE nomproduit, prixvente, prixachat, quantitestock FROM produits where nomproduit='.$nomproduit.'and prixvente=.'$prixvente and prixachat=.'$prixachat and quantitestock=.'$quantitestock");
?>
